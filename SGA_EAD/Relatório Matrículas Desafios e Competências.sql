-- Query extrai os dados de alunos nas turmas de Desafios ou Competências, podendo buscar tanto em turmas específicas ou apenas por Desafios e Competências

WITH
	MATRICULA AS (
		SELECT DISTINCT
				a.nom_aluno, a.cod_aluno, a.nom_curso, d.nom_disciplina, d.cod_disciplina, d.nome_curso, d.seq_Turma, d.ano, d.semestre
		...
		WHERE   d.ano = 2023
				...
				AND d.seq_Turma in (2457101, 0522101, 8600101, 8564101,
									...
									9107101, 4156101, 3763101, 8469101) --Filtra por disciplinas exatas
...
ORDER BY m.seq_Turma, tipo_aluno, p.num_periodo